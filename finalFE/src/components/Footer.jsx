...
export default function Footer() {
  return (
    <footer className="bg-orange-800 text-black py-10">
      <div className="container mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {/* Section kiri */}
        <div>
          <h2 className="font-bold text-xl mb-4 text-white">ANGELIQUE </h2>
          <p>
          Find the perfect furniture for your home with our high-quality designs and collections.
          </p>
          <button className="mt-4 px-4 py-2 border border-white rounded hover:bg-white hover:text-orange-800 transition">
            Sign Up
          </button>
        </div>
